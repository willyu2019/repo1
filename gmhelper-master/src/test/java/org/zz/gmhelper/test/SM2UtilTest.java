...
public class SM2UtilTest extends GMBaseTest {
    ...
    public void testSignAndVerify() {
        try {
           ...
           byte[] rawSign1 =Hex.decode("5e36362f4a840d0cdd0161ccb53a454bb42fb68a6d4d0d29a1176c9c29809b57f2fe0c122f79c1a49bce4e28f8c22d08a2736fa40d3534404a02a1b5104bf558" );
            //处理Der编码
            sign = SM2Util.encodeSM2SignToDER(rawSign1);
            System.err.println("adfdsafd:"+Hex.toHexString(sign));
            System.out.println("SM2 sign with withId result:\n" + ByteUtils.toHexString(sign));


            //tlv 编码

            byte[] data = ByteUtils.fromHexString("779a015b595ddd3961100ce8d4d3fb248a44619b3adabb50bfa7f7fab2e232a4dfda639e08113ea9a4e50e88ab31f04f79ce2bad66d87b4d23e78e02eb1bf41d");

            System.err.println("TLV"+Hex.toHexString(SM2Util.encodeSM2SignToDER(data)));
