...
public class SM2X509CertMakerTest {
    ...
    public void testMakeCertificate() {
        try {
            ...
            savePriKey("test.sm2.pri", (BCECPrivateKey) subKP.getPrivate(), (BCECPublicKey) subKP.getPublic());
...
//            X509Certificate cert1 = certMaker.makeCertificate(true,
//                    new KeyUsage(KeyUsage.digitalSignature | KeyUsage.dataEncipherment
//                            | KeyUsage.keyCertSign | KeyUsage.cRLSign),
//            FileUtil.writeFile("ys.cer", cert1.getEncoded());
        } catch (Exception ex) {
            ex.printStackTrace();
            Assert.fail();
        }
